        ...
        <div class="page-box">
            ...
            <div class="page">
                ...
                <div class="table-of-contents-container">
                    <a class="table-of-contents-item" href="#what-is-cbdc">What is a CBDC?</a><br />
                    <a class="table-of-contents-item" href="#privacy">Privacy Concerns</a><br />
                    <a class="table-of-contents-item" href="#control">Dystopian Control</a><br />
                    <a class="table-of-contents-item" href="#volatile">Less Volatile?</a><br />
                    <a class="table-of-contents-item" href="#ownership">Ownership</a><br />
                    <a class="table-of-contents-item" href="#ccp">Comparison to China's CCP</a><br />
                </div>

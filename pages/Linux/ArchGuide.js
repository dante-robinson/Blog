...
export default function ArchGuide() {
  return (
    <div className="text-foreground text-sm py-[2vh] px-[2vw] space-y-[1vh]">
      ...
      <p>and that’s the partitions finished off if your running a similar setup to me If you made a separate partition for your /home directory just run the ame command on that partition unless your running
      ...
      <p>
        ...
        <b>@snapshots</b> - snapper will store your BTRFS Snapshots here if not using snapper this partition is not needed
      </p>
      ...
      <p>you may need to change the /dev/nvme0n1 command to your specific partition if not using an NVME drive setup the same way I have mine.</p>
      ...
      <p>once in the locale.gen file you will see a lot of lanaguages all you need to do is scroll down to your lanaguge in my case “en_US.UTF-8 UTF-8” and what your going to want
        ...
        the system. After that we do Control + X and then it will ask to save the buffer we just press Y then it should ask file name to write just press enter. Now run this command

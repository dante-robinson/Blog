...
export default function PerformanceGuide() {
  return(
    <div className="text-sm text-foreground py-[2vh] px-[2vw] space-y-[1vh]">
      ...
      <p>Alot of people may prefer to create a bunch of dotfiles in there home directory to allow different users to have different settings for things like pacman, audio, makepkg settings etc.
      ...
      Guide we have already installed the reflector package we need and just need to set up reflector and enable the systemd service. If you havent installed reflector you can do so for your
      ...
      <p>Now we can configue the pacman configuration file to enable parallel downloads by running</p>
      ...
      <p>Although we haven’t really have to build anything on our own system yet in this guide we will need to and it would be nice if we could use the full proccessing power of our system for those
      ...
      <p>This will install yay for us and may install go along the way thats about it now we can go back to our home fodler by running</p>
      ...
      prefrences under the sandwhich looking icon beside the minimize window button and under the tab AUR or Third Party make sure Enable AUR Support is Enabled. Under the General tab you can also
      ...
      <p>If your running an older AMD GPU such as 300 series or older thne you may be running on the radeon driver and you can open this instead</p>
      ...
      I still do incase I need to connect to a SATA Drive though. We need to first run</p>
      ...
      <p>Lastly we are just going to set the hdparam rules. This wil cause your Internal and External HDDs to never turn off so if you use an external drive or have a HDD in your system
      thats a secondary drive you may want to not set this or unplug your external drive unless needed as it will probably cause the drive to die sooner just from never being able to sleep.
      ...
      alows us to automatically set NVMe Drives to none and set any SATA drives to run on BFQ we can do this by running</p>

    ...
    <div class="page-box">
      ...
      <div class="page">
        <body>
          ...
          <p>
            For hardware you can use pretty much anything you will need to note
            the current blockchain size however whcih can be checked at the link 
            below and will need a HDD (preferably an SSD) greater than the size 
            at the time of writing 1TB is enough but 2TB is preferred, the current
            blockchain size is 489GB.
          </p>

          <a href="https://ycharts.com/indicators/bitcoin_blockchain_size" class="link">
          ...
          <p>
            ...
            node. Below is an intro to the Lightning Network.
          </p>

          <a class="link" href="https://youtu.be/yKdK-7AtAMQ?t=106">https://youtu.be/yKdK-7AtAMQ?t=106</a>
          ...
          <p>
            Remember to be responsible with what software updates you run and in 
            turn "vote" for, things are working always ask why is that change 
            needed and how does it affect decentralization because without that 
            we might as well use fiat (government money). A good read would be 
            "The Blocksize War by Jonathan Bier" which covers a change back in 
            2017 to make larger blocks to solve transaction speed issues which 
            in turn makes the chain bigger, which requires node operators to be 
            more wealthy and afford more storage. Changes like these are what you 
            as a node operator need to be mindful of as they can hurt decentralization.
            Big blocks may not be a big problem if say a 2TB SSD is 10$.
          </p>

          <p>
            Here's 2 fun images for
            you one about changing the code and the other about convincing others
            sometimes it's just not worth your time. Weather you have been in 
            this space for awhile or have joined recently and don't know El 
            Salvador is using BTC as legal tender (currency) we are happy to have
            you and are happy to see you helping the network, continue on satoshi.
          </p>

          <div class="two-image-container">
            <div class="image-container first-image-inside-container">
              <img src="../../images/BSD/BitcoinNode/ChangeCode.jpg" alt="XRP Distribution" />
            </div>
            <div class="image-container second-image-inside-container">
              <img src="../../images/BSD/BitcoinNode/Haters.jpg" alt="XLM Distribution" />
            </div>
          </div> 
        </body>
      </div>
